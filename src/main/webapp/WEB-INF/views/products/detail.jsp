  ...
  <header id="layout-header">
			...
			<div id="header-content">
				<nav id="main-nav">
					...
					<ul class="clearfix">
						...
						<li><a href="/pages/perguntas-frequentes" rel="nofollow">Frequently asked questions</a></li>
					</ul>
				</nav>
			</div>
		</div>
	...
	<div class="container">
	  ...
	  <section class="data product-detail">
	    ...
	    <p></p>
	    <p>Published in: ${product.published } </p>
	    <p>Found an erro? <a href='/submissao-errata' target='_blank'>Submit a request</a></p>
	  </section>
	</div>
